return {
  ...
  -- /home/tig/.cache/nvim/codeium/bin/1.6.7/language_server_linux_x64
  -- event = "InsertEnter",
  --   config = function()
  --   require("codeium").setup({
  --     tools = {
  --       language_server = "/etc/profiles/per-user/tig/bin/codeium_language_server",
  --     },
  --   })
  --     vim.g.codeium_bin = "/etc/profiles/per-user/tig/bin/codeium_language_server"
